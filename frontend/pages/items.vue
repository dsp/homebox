  ...
  <BaseContainer>
    <div v-if="locations && tags">
      <div class="flex flex-wrap items-end gap-4 md:flex-nowrap">
        ...
        <!-- md:contents lets the pair join the outer flex row on desktop while
             sharing one row (mic + full-width button) when wrapped on mobile -->
        <div class="flex w-full gap-4 md:contents">
