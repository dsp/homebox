...
| HBOX_SPEECH_BASE_URL                    |                                                                                                | API root of an OpenAI-compatible speech-to-text provider used for voice input, e.g. `https://api.mistral.ai/v1`, `https://api.openai.com/v1`, or `https://api.groq.com/openai/v1`. Voice input is disabled unless both this and HBOX_SPEECH_MODEL are set. |
...
| HBOX_SPEECH_TIMEOUT                     | 30s                                                                                            | Timeout for a single transcription request to the provider.                                                                                                                               |
